...
public class Helado extends Planeta implements tieneAsentamientos{
    ...
    ***********************************************************
    ...
    Inicializa un objeto o planeta de tipo Helado, asignando los valores del radio, cristales de hidrógeno, 
    flores de sodio y generando una temperatura aleatoria para cada planeta.
    */
    public Helado(int radio, int cristalesHidrogeno, int floresDeSodio){
        super(radio, cristalesHidrogeno, floresDeSodio);
        this.temperatura = (int)generarTemperatura();
    ...
    ***********************************************************
    Descripción breve de lo que hace  
    Calcula la nueva temperatura aleatoria entre -120 y -30.
    */
    private double generarTemperatura() {
        Random rand = new Random();
        return rand.nextInt((-120), (-30));
    }
    ...
    ***********************************************************
    Descripción breve de lo que hace  
    Devuelve la representación en texto del objeto Helado.
    */
    @Override
    ...
    */
    ...
    public boolean visitar(Jugador jugador) {
        ...
        int RecursoExtraido;
        System.out.println("Visitando planeta Helado.");
        if (rand > 0.5) 
        while (seguir) {
            System.out.println("\nRadio: " + radio);
